<?php
	...
	$guide = array(
		...
		'nav1' => array(
			'title' => 'Basic',
			'div1' => 'Proposed Name',
			'p1' => 'The restriction of BVI company name is loose and English name is allowed. The name may contain words such as international, group, holding, industrial and investment. At the same time, you can add the name of the country or region you like before the company name: China, Hong Kong, etc. The company name must end with Limited, Corporation, Incorporated, Societe Anonyme or Socieded Anonima or the abbreviation of the above words. (note: unless specially approved by the government, the company name shall not contain words such as Assurance, Bank, Building Society, Chamber of Commerce, Chartered, Cooperative, Imperial, Insurance, Municipal, Royal or Trust.) We will check the proposed name. If the name fails to pass, we will remind you to change the name by email or system message.',
			...
			'p5' => 'The standard authorized capital is USD 50,000, which is divided into 50,000 shares, 1 dollar per share (if the registered capital exceeds USD 50,000 or the number of issued shares is greater than 50,000, the additional fee charged by the government is USD1350).',
		...
		'nav2' => array(
			...
			'p2' => '1. After the basic information of the registration application is approved, we will notify you by email and send the documents that require signature confirmation by the directors to the recipient\'s e-mail. After the completion of the signature confirmation, the scanned copy of signed document need to be sent back.<br/>
			2. Please keep the paper version of the signed documents and the provided director/member documents, such relevant documents must be mailed to the assigned address after the registration is completed.',
		),
		'nav3' => array(
			'title' => 'Price',
			'div1' => 'Basic fee of registering BVI company: 15800/ one-time (required)',
			...
			'div2' => 'The annual management fee is ￥11,000 / year',
			'p2' => '',
			'div3' => 'Certificate notarization for shareholders/directors: ￥3410 (one-time fee)',
			'p3' => '',
			'div4' => 'Bank account assistance: ￥3410 for each one',
		...
		'nav5' => array(
			...
			'div3' => 'Other information',
			'p3' => 'Purchase of the registered BVI shell is also provided.',
		),
	);

	$basic = array(
		'title' => 'Basic Information',
		'h1' => 'Apply for BVI companies limited by shares',
		'div1' => array(
			'h6' => 'BVI companies limited by shares',
			'p' => 'The registration period is 15 workingdays after submitting the materials.<br />The average length takes 12 working days.<br />One time registration fee is ¥15800.',
			'div' => 'MORE'
		),
		'div2'  => array(
			'money' => '¥15800',
