<?php
	...
	$guide = array(
		...
		'nav1' => array(
			'title' => '基本信息',
			'div1' => '有限格式拟用名称',
			'p1' => '公司名称可以使用下列结尾：Limited、Corporation、Incorporated、Societe、Anonyme、Ltd.、Inc.、Corp. S.A；例如：ABC LTD.。公司名称不能使用以下词汇：Royal、Imperial、Government、Chartered。如公司名称需要使用Bank、Insurance、Trust，需要向开曼公司注册署申请核准。我们会对公司英文名称进行查名，如遇核名未能通过时，我们会通过邮件形式或系统消息提醒您更换名称。',
			'div2' => '订单接收人',
			'p2' => '用于有限公司注册过程中信息和材料往来唯一的接收人，必须确保邮箱、电话、邮寄地址真实有效。',
			'div3' => '董事／股东',
			'p3' => '1、本次注册至少需要1名董事/股东，董事/股东可由自然人或法人担任，自然人无国籍限制，需年满18周岁；<br/>
					2、董事主席是董事会的负责人，由股东选举产生，一人或一人以上；<br/>
					3、股东名册须存放于开曼注册代理，公司发行记名股票，无须公布受益人身份资料，一人或一人以上；',
			'div4' => '注册流程',
			'div5' => '注册资本',
			'p5' => '最低注册资本为50,000美金，分为5万股，每股1美元。超过标准资本的要额外加收税金如下(成立及每年年检費用):<br/>
			1、注册资本(US$)<-51,200，额外加收税金(US$)855<br/>
			2、注册资本(US$)51,201-<-1,000,000，额外加收税金<br/>(US$)1,220<br/>
			3、注册资本(US$)1,000,001<-2,000,000，额外加收税金<br/>(US$)2,420<br/>
			4、注册资本(US$)>2,000,000，额外加收税金(US$) <br/>
			注：注册资金不需要验资及到位。',
			'div6' => '注册代理/注册地址',
		...
		'nav3' => array(
			'title' => '服务价格',
			'div1' => '注册全新开曼公司基本费用￥30800/一次性（必选项）',
			'p1' => '政策解读、申报申请费用、提供标准办公地址首年费用、委任公司秘书首年费用、指导项目完成政府问卷审核、邮件代收自取。',
			'div2' => '管理年费￥24600/年',
			'p2' => '',
			'div3' => '股东/董事证件公证￥3410/一次性',
			'p3' => '',
			'div4' => '银行开户协助服务￥6820/间',
		...
		'nav5' => array(
			'title' => '其他须知',
			'div1' => ' 银行开户',
			'p1' => '开曼此类离岸注册地银行开户难度很大，若有银行开户需求，请选择新加坡或香港注册地。',
			'div2' => ' 注册原件',
