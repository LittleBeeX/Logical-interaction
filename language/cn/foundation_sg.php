<?php
	...
	$guide = array(
		...
		'nav1' => array(
			'title' => '基本信息',
			'div1' => ' 基金会拟用名称',
			'p1' => '基金会拟用名称仅限英文名，例如：ABC FOUNDATION LTD.，该名称需要注册局核名后方可有效，如遇核名未能通过时，我们会通过电话客服或系统消息提醒您更换名称。',
			'div2' => ' 订单接收人',
			'p2' => '用于基金会注册过程中信息和材料往来唯一的接收人，必须确保邮箱、电话、邮寄地址真实有效。',
			'div3' => ' 董事／成员',
			'p3' => '1、董事为基金会决策人，负责签署基金会所有相关事务。<br/>
			2、本次注册至少需要2名董事，其中至少一名董事必须为新加坡公民或PR，如您选择购买“本地名义董事”服务，我们将为您提供1名本地名义董事，我们提供的董事不出任成员。<br/>
			3、成员又名担保人，为基金会承担提前约定的债务责任，最少可为1SGD，但建议增加数额，比如1000SGD。<br/>
			4、本次注册至少需要1名成员，董事可出任成员，我们提供的名义董事除外。',
			'div4' => ' 注册流程',
		),
		'nav2' => array(
			'title' => '材料清单',
			...
			'div2' => ' 需签署文件',
			'p2' => '注册申请的基本信息审核通过后，我们将以邮件方式通知您并将需要董事签署确认的文件发至订单接收人邮箱，签署完成后需将已签署文件扫描件回执。<br>请妥善保存已签署纸质版文件及提供的董事／成员资料复印件，相关资料需要在注册完成后邮寄至注册地址。',
		),
		'nav3' => array(
			'title' => '服务价格',
			'div1' => ' 本地注册￥7500/一次性 （必选项）',
			'p1' => '若CLG注册因项目原因被拒无法退款',
			'div2' => ' 法定秘书服务￥6000/年 （必选项）',
			'p2' => '基金会必须有一位新加坡籍公民担任秘书',
			/*'div3' => ' 法定秘书服务￥6000/年 （必选项）',
			'p3' => '基金会必须有一位新加坡籍公民担任秘书',*/
			'div4' => ' 注册地址和邮件管理服务￥1500/年（必选项）',
			'p4' => '服务包含控制面板标准办公地址，邮件代收自取等内容',
			'div5' => ' 本地名义董事挂名服务￥30000/年',
			'p5' => '基金会必须有一名董事为新加坡公民或PR，选择该项服务，我们将为您提供1名新加坡籍董事，本项服务提供的董事不出任成员。',
			'div6' => ' 银行开户协助服务￥2000/间',
			'p6' => '银行开户申请提交后我们将为您预约开户银行，收到银行预约通知后，需文件签署董事进行面签事宜，请保持手机畅通，客服工作人员将联系您。',
		),
		'nav4' => array(
			'title' => '支付方式',
			'div1' => ' 支付宝',
	...
	$add_director = array(
		'title' => '董事信息',
		'h1'  	=> '董事基本信息',
		'div' 	=> '特别说明：<br /> 1、董事为基金会决策人，负责签署基金会所有相关事务。
					<br /> 2、本次注册至少需要2名董事，其中至少1名董事必须为新加坡公民或PR，如您已购买“本地名义董事”服务，我们将为您提供1名本地名义董事，我们提供的董事不出任成员。',
		'div1' => array(
			'b' => '护照信息',
			'labe' => '试一试上传护照自动识别填写',
			'b1'   => '类型',
	...
	$director_list = array(
		'title' => '董事信息',
		'h1' => '特别说明：<br /> 1、董事为基金会决策人，负责签署基金会所有相关事务。
					<br /> 2、本次注册至少需要2名董事，其中至少1名董事必须为新加坡公民或PR，如您已购买“本地名义董事”服务，我们将为您提供1名本地名义董事，我们提供的董事不出任成员。',
		'dis' => '代理董事',
		'del' => '删除',
		'upd' => '修改',
	...
	$add_member = array(
		'title' => '成员信息',
		'h1'  	=> '成员基本信息',
		'div' 	=> '特别说明：<br /> 1、成员又名担保人，为基金会承担提前约定的债务责任，最少可 为1SGD，但建议增加数额，比如1000SGD。
					<br /> 2、本次注册至少需要1名成员，董事可出任成员，我们提供的名义董事除外。',
		'is_pass' => '<br />3、如果您还需添加成员，您可以在本页面填写成员信息，如无需新增，则可以<a href="javascript:void(0)" id="pass" class="c-f76959 di">点击此处跳过>></a>',
		'div1' => array(
			'b' => '护照信息',
			'labe' => '试一试上传护照自动识别填写',
			'b1'   => '类型',
	...
	$member_list = array(
		'title' => '成员信息',
		'h1' 	=> '特别说明：<br /> 1、成员又名担保人，为基金会承担提前约定的债务责任，最少可 为1SGD，但建议增加数额，比如1000SGD。
					<br /> 2、本次注册至少需要1名成员，董事可出任成员，我们提供的名义董事除外。',
		'del' => '删除',
		'upd' => '修改',
		'con' => '确认',
	...
	$mem_next_ajax = array(
		'return_error' => '基金会必须满足两名董事一名成员',
		'return_error1' => '基金会必须有一名成员',
		'return_success' => '成功'
	);
