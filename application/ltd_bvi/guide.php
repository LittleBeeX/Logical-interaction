<div class="apply-more-main-list">
	<div class="apply-more-main ub ub-ver cff">
		...
		<div class="ub-f1 ub cff">
			<div class="apply-slide-main ub-f1 w100 swiper-container-horizontal">
				<div class="bs-wrapper apply-wrapper">
					...
					<div class="bs-slide apply-slide plr30 pb40 swiper-slide-active" style="width: 375px;">
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav1']['div1']?></div>
						...
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav1']['div2']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav1']['p2']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav1']['div3']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav1']['p3']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav1']['div5']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav1']['p5']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav1']['div6']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav1']['p6']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav1']['div7']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav1']['p7']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							...
							<div class="apply-slide-con fz22 lh16 word-break pt10">
								<div class="apply-flow pb40">
									<img src="/public/assets/weixin/images/ltd_bvi_<?=$this->languageName?>.png" />
								</div>
							</div>
						</div> 
					</div>

					<div class="bs-slide apply-slide plr30 pb40 swiper-slide-next" style="width: 375px;">
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav2']['div1']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav2']['p1']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav2']['div2']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav2']['p2']?></p>
							</div>
						</div>
					...
					<div class="bs-slide apply-slide plr30 pb40 swiper-slide-active">
						<div class="apply-slide-item pt40 mt20">
					...
					<div class="bs-slide apply-slide plr30 pb40" style="width: 375px;">
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav4']['div1']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav4']['p1']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav4']['div2']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav4']['p2']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav4']['div3']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav4']['p3']?></p>
							</div>
						</div>
					...
					<div class="bs-slide apply-slide plr30 pb40" style="width: 375px;">
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav5']['div1']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav5']['p1']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav5']['div2']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav5']['p2']?></p>
							</div>
						</div>
						<div class="apply-slide-item pt40 mt20">
							<div class="apply-slide-tit ub ub-ac fz28 fw-b">
								<i class="iconfont icon-start fz24 pr10"></i><?=$guide['nav5']['div3']?></div>
							<div class="apply-slide-con fz22 pl30 lh16 word-break pt10">
								<p><?=$guide['nav5']['p3']?></p>
							</div>
						</div>
