...
<div class="apply-toggle-box plr30 pt10">
	<div class="apply-toggle-tit">
		<b class="fw-b"><?= $add_member['div1']['b']?></b>
		<?if (empty($is_pay)) {?>
		<label class="apply-file-btn  fz22 ptb5 plr10 ml30 c-0070ba bd-0070ba"><?= $add_member['div1']['labe']?>
	...
	<div class="apply-toggle-main">
		<ul class="apply-reg-list fz26 c66 pt40 moren">
			<li>
				<label>
					<b><?= $add_member['div1']['b1']?></b>
					<input type="text" reg="nomarl" id="passport_type" value="<?= $people['passport_type']?>" />
				</label>
				<p><span><?= $add_member['div1']['p1']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div1']['b2']?></b>
					<input type="text" reg="nomarl" id="country_code" value="<?= $people['country_code']?>"/>
				</label>
				<p><span><?= $add_member['div1']['p2']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div1']['b3']?></b>
					<input type="text" reg="nomarl" id="passport_no" value="<?= $people['passport_no']?>"/>
				</label>
				<p><span><?= $add_member['div1']['p3']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div1']['b4']?></b>
					<input type="text" reg="nomarl" id="name" value="<?= $people['name']?>"/>
				</label>
				<p><span><?= $add_member['div1']['p4']?></span></p>
			</li>

			<li class="bb ub ub-ac">
				<div class="db"><?= $add_member['div1']['b5']?></div>
				<div class="ub-f1 ml30">
					<div class="selectbox">
						<div class="select-txt ub ub-ac" id="sex" data-value="1">
							<?if ($people['sex'] == 1) {
								echo  $add_member['div1']['p5-1'];
							}else if($people['sex'] == 2){
								echo  $add_member['div1']['p5-2'];
							}?>
						</div>
						<div class="select-list">
							<div class="select-item ub-te plr30 ub-ac ub" data-value="1"><?= $add_member['div1']['p5-1']?></div>
							<div class="select-item ub-te plr30 ub-ac ub" data-value="2"><?= $add_member['div1']['p5-2']?></div>
						</div>
					</div>
				</div>
			</li>
			...
			<li class="bb ub ub-ac">
				<div class="db"><?= $add_member['div1']['b6']?></div>
				<div class="ub-f1 ml30">
					<div class="selectbox">
			...
			<li>
				...
				<p><span><?= $add_member['div1']['p7']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div1']['b8']?></b>
					<input type="text" reg="nomarl" id="place_birth" value="<?= $people['place_birth']?>">
				</label>
				<p><span><?= $add_member['div1']['p8']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div1']['b9']?></b>
				...
				<p><span><?= $add_member['div1']['p9']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div1']['b10']?></b>
					<input type="text" reg="nomarl" id="place_issue" value="<?= $people['place_issue']?>"/>
				</label>
				<p><span><?= $add_member['div1']['p10']?></span></p>
			</li>
		</ul>
	</div>
</div>
<div class="apply-toggle-box plr30 pt10">
	<div class="pt10">
		<b class="fw-b fz28 c28"><?= $add_member['div2']['b']?></b>
	</div>
	<div class="apply-toggle-main">
		<ul class="apply-reg-list fz26 c66 pt40 moren">
			<li>
				<label>
					<b><?= $add_member['div2']['b1']?></b>
					<input type="text" reg="nomarl" id="address" value="<?= $people['address']?>"/>
				</label>
				<p><span><?= $add_member['div2']['p1']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div2']['b2']?></b>
					<input type="text" reg="email" id="email" value="<?= $people['email']?>">
				</label>
				<p><span><?= $add_member['div2']['p2']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div2']['b3']?></b>
					<input type="text" reg="number" maxlength="16" id="mobile" value="<?= $people['mobile']?>"/>
				</label>
				<p><span><?= $add_member['div2']['p3']?></span></p>
			</li>
			<li>
				<label>
					<b><?= $add_member['div2']['b4']?></b>
					<input type="text" id="wechat" reg="" id="wechat" value="<?= $people['wechat']?>"/>
				</label>
				<p><span><?= $add_member['div2']['p4']?></span></p>
			</li>
		</ul>
		<input type="hidden" id="type" value="<?= $people['type']?>"/>
	</div>
</div>

<div class="ptb50 mb40 plr30 font-upper">
<?if (empty($is_pay)) {?>
	<a href="javascript:void(0)" id="btn" class="ub ub-pac bg0070ba fz26 cff lh1 ptb40 mb40 mt30"><?= $add_member['button']?></a>
<?}else{?>
	<?if (!empty($oid)) {?>
		<a href="javascript:void(0)" id="btn" class="ub ub-pac bg0070ba fz26 cff lh1 ptb40 mb40 mt30"><?= $add_member['button']?></a>
	<?}else{?>
		<a href="javascript:history.back(-1)" class="ub ub-pac bg0070ba fz26 cff lh1 ptb40 mb40 mt30"><?= $add_member['back']?></a>
	<?}?>
<?}?>
</div>
...
<script type="text/javascript">
	...
	$('#pass').on('click',function(){
		...
		tips('','','0',{
			...
			cb: function() {
				$.ajax({
					url : '<?=$this->url("foundation_sg/member_pass")?>',
					type : 'POST',
					data : {oid:oid,code:code},
					dataType : "json",
			        success:function(e){
			        	if (e.state == 0) {
							window.location.href="<?=$this->url("foundation_sg/member_list")?>?oid="+oid+"&code="+code;
			     			return false;
			        	}
	...
	$('#btn').on('click',function(){
		...
		tips('','','0',{
			...
			cb: function() {
				$.ajax({
					url : '<?=$this->url("foundation_sg/people_ajax")?>',
					type : 'POST',
					data : data,
					dataType : "json",
			        success:function(e){
			        	if (e.state == 0) {
			        		...
			        		setTimeout(function(){
								window.location.href="<?=$this->url("foundation_sg/member_list")?>?oid="+e.oid+"&code="+e.code+'&is_pay='+is_pay+'&noback='+noback;
			        		},2000)
			        		return false;
			        	}
			      		tips(e.info,'warning',1000);
	...
	$(".upload").change(function(){
		...
		tips('','','0',{
			...
			cb: function() {
				$.ajax({
		            url:'<?= $this->url('foundation_sg/hz_upload_ajax')?>',
		            type:'POST',
		            data:formData,
		            cache: false,
