<div class="pt110">
	...
	<!-- 注册基本信息 -->
		<a href="<?= $this->url('ltd_bvi/basic')?>?oid=<?= $oid?>&code=1&is_pay=<?= $is_pay?>" class="ub ub-ac c28 ptb36 bb">
	...
	<!-- 查看／新增服务项目 -->
		<a href="<?= $this->url('ltd_bvi/project')?>?oid=<?= $oid?>&code=1" class="ub ub-ac c28 ptb36 bb">
	...
	<!-- 董事信息 -->
		<a href="<?= $this->url('ltd_bvi/director_list')?>?oid=<?= $oid?>&code=1&is_pay=<?= $is_pay?>" class="ub ub-ac c28 ptb36 bb">
	...
	<!-- 成员信息 -->
		<a href="<?= $this->url('ltd_bvi/member_list')?>?oid=<?= $oid?>&code=1&is_pay=<?= $is_pay?>" class="ub ub-ac c28 ptb36 bb">
	...
	<!-- 个人资料 -->
		<a href="<?= $this->url('ltd_bvi/dir_mem_list')?>?oid=<?= $oid?>&code=1&is_pay=<?= $is_pay?>" class="ub ub-ac c28 ptb36">
