    ...
    <div class="row-fluid">
        <div class="span12">
            <div class="box box-color box-bordered">
                ...
                <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('service/ltd_cym_add_ajax')?>" name="form_regist" id="form_regist" enctype="multipart/form-data" >
