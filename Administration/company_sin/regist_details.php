        ...
        <div class="span12">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    ...
                    <div class="actions">
                        <a rel="tooltip" data-original-title="新增人员" href="<?=$this->url('company_sin/regist_partner_add')?>?oid=<?=$registlist['id']?>" class="btn btn-danger">
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($peoplelist as $key=>$val){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="查看详情" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("company_sin/regist_partner_details")?>?id=<?=$val["id"]?>"><i class="icon-eye-open"></i></a>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("company_sin/regist_partner_up")?>?id=<?=$val["id"]?>"><i class="icon-edit"></i></a>
                                    <a href="javascript:pub_alert_confirm(this,'确定要删除吗？','<?=$this->url("company_sin/regist_partner_de")?>?id=<?=$val["id"]?>');" rel="tooltip" class="btn btn-small btn-danger" title="删除"><i class="icon-remove"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
            ...
            <div class="box box-color box-bordered">
                <div class="box-title">
                    ...
                    <?if(empty($porder2)&&$onumber<$snumber){?>
                        <a rel="tooltip" data-original-title="新增服务项目" href="<?=$this->url('company_sin/regist_order_add')?>?oid=<?=$registlist['id']?>&uid=<?=$registlist['uid']?>" class="btn btn-danger">
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($porder as $k=>$v){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="查看详情" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("company_sin/regist_order_details")?>?id=<?=$v["id"]?>"><i class="icon-eye-open"></i></a>
                                    <?if($v['state']!=2){?>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("company_sin/regist_order_up")?>?id=<?=$v["id"]?>"><i class="icon-edit"></i></a>
                                    <?}?>
                                </td>
                            </tr>
                        <?}?>
