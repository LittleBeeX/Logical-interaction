        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <div class="box-content nopadding">
                    <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('company_sin/wait_order_add_ajax')?>?oid=<?=$_GET['oid']?>&uid=<?=$_GET['uid']?>" name="form_regist" id="form_regist" enctype="multipart/form-data" >
