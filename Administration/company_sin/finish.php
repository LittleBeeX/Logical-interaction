                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($registlist as $k=>$v){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="查看详情" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("company_sin/finish_details")?>?id=<?=$v["id"]?>"><i class="icon-eye-open"></i></a>
                                    <a data-original-title="处理" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("company_sin/finish_up")?>?id=<?=$v["id"]?>"><i class="icon-edit"></i></a>
                                    <a href="javascript:pub_alert_confirm(this,'确定要删除吗？','<?=$this->url("company_sin/finish_de")?>?id=<?=$v["id"]?>');"  class="btn btn-small btn-danger" rel="tooltip" title="删除注册订单"><i class="icon-remove"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
