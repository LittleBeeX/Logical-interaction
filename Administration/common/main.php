...
<body class='login' style="background-image: url('/public/assets/sysadmin/img/1.jpg');background-repeat: no-repeat;background-position: center;">
	<img src="/public/assets/sysadmin/img/1-2.png" style="position:absolute;top:50px;left:50px;max-width:100px;" />
	<div class="wrapper">
		<h1><a href="javascript:viod(0);" style="font-size: 43px;">LittleBeeX管理系统</a></h1>
		<div class="login-body">
			...
			<form action="" id="login" name="login" method='post'>
				...
				<div class="pwd" style="margin-top: 10px;">
					<input type="password" name="password" id="password" placeholder="密码" class='input-block-level' style="width: 185px;float: left;height: 25px;" />
					<input type="submit" value="进入系统" class='btn btn-primary' style="height: 35px;width: 95px;float: right;" />
	...
	$.ajax({
		...
		success:function(r){
			if(r.state == 1){
				...
				window.location.href = "<?= $this->url('index/index')?>";
			}
		}
	});
	return false;
