...
<meta http-equiv='Refresh' content="<?=$sleep?>;URL=<?=$this->url('main')?>">
<meta name="viewport" content="width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=no" />
<meta name="apple-mobile-web-app-capable" content="yes" />
<meta names="apple-mobile-web-app-status-bar-style" content="black-translucent" />
<title><?=$msg?></title>
<link rel="shortcut icon" href="/2qianbao.ico" />
...
<body class='error'>
	<div class="wrapper">
		...
		<div class="buttons">
			<div class="pull-left"><a href="<?=$this->url('main')?>" class="btn"><i class="icon-arrow-left"></i> 返回</a></div>
		</div>
	</div>
