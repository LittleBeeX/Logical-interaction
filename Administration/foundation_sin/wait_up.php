    ...
    <div class="breadcrumbs">
        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('foundation_sin/wait_up_ajax')?>" name="form_bill" id="form_bill">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="data[state]" class="input-xlarge">
                                ...
                                <option value="3" <?if($registlist['state']==3){echo "selected";}?>>审核通过进入文件签署</option>
                            </select>
                        </div>
                    </div>
                    <div class="control-group">
