    ...
    <div class="breadcrumbs">
        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('foundation_sin/finish_up_ajax')?>" name="form_bill" id="form_bill">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="data[state]" class="input-xlarge">
                                <option value="5" <?if($registlist['state']==5){echo "selected";}?>>退回到注册审查</option>
