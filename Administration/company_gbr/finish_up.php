    ...
    <div class="breadcrumbs">
        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('company_gbr/finish_up_ajax')?>" name="form_bill" id="form_bill">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="data[state]" class="input-xlarge">
                                <option value="6" <?if($registlist['state']==6){echo "selected";}?>>暂不处理</option>
...
<script type="text/javascript">
    ...
    //         var key = $(this).val();
    //         $.ajax({
    //             url:'<?= $this->url("company_gbr/finish_up_ajaxA")?>',
    //             type:'post',
    //             data:{key:key},
    //             dataType:'json',
    //             success:function(e){
