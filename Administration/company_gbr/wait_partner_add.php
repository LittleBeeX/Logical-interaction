        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <div class="box-content nopadding">
                    <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('company_gbr/wait_partner_add_ajax')?>?oid=<?=$oid?>&type=<?=$type?>&sort=<?=$sort?>" name="regist_partner_up" id="regist_partner_up">
