    ...
    <div class="breadcrumbs">
        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('company_gbr/regist_up_ajax')?>" name="form_bill" id="form_bill">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <select name="data[state]" class="input-xlarge">
                                ...
                                <option value="2" <?if($registlist['state']==2){echo "selected";}?>>审核通过进入到订单审核</option>
                            </select>
                        </div>
                    </div>
