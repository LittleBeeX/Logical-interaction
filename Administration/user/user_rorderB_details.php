            ...
            <div class="box box-color box-bordered">
                ...
                <form class="form-horizontal form-bordered form-validate"  name="form_regist" id="form_regist">
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <input type="text" name="type" value="<?
                           foreach ($registerorder_country as $ag => $bg) {
                               if($registlist['country']==($ag+1)){
                                    echo $bg;
                               }
                           }
                           ?>"  class="input-xlarge" data-rule-required="true" disabled="disabled"/>
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <!-- <input type="text" name="type" value="<?
                           foreach ($country as $axg => $bxg) {
                               if($registlist['region']==($axg+1)){
                                    echo $bxg;
                               }
                           }
                           ?>"  class="input-xlarge" data-rule-required="true" disabled="disabled"/> -->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <!--  <input type="text" name="type" value="<?
                           foreach ($country as $ag1 => $bg1) {
                               if($registlist['register_address4']==($ag1+1)){
                                    echo $bg1;
                               }
                           }
                           ?>"  class="input-xlarge" data-rule-required="true" disabled="disabled"/> -->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <!-- <input type="text" name="type" value="<?
                           foreach ($country_mobilecode as $kwws => $vwws) {
                               if($registlist['mobile_code']==($kwws+1)){
                                    echo $vwws['code'];
                               }
                           }
                           ?>"  class="input-xlarge" data-rule-required="true" disabled="disabled"/> -->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                           <!-- <input type="text" name="type" value="<?
                           foreach ($registermember_currencytype as $agt => $bgt) {
                               if($rebasic['currency_type']==($agt+1)){
                                    echo $bgt;
                               }
                           }
                           ?>"  class="input-xlarge" data-rule-required="true" disabled="disabled"/> -->
                    ...
                    <div class="control-group">
                        ...
                        <div class="controls">
                            <!-- <input type="text" name="type" value="<?
                           foreach ($registermember_applyway as $agxw => $bgxw) {
                               if($rebasic['apply_way']==($agxw+1)){
                                    echo $bgxw;
                               }
                           }
                           ?>"  class="input-xlarge" data-rule-required="true" disabled="disabled"/> -->
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($peoplelist as $key=>$val){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="查看详情" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("user/user_partnerB_details")?>?id=<?=$val["id"]?>"><i class="icon-eye-open"></i></a>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("user/user_partnerB_up")?>?id=<?=$val["id"]?>"><i class="icon-edit"></i></a>
                                    <a href="javascript:pub_alert_confirm(this,'确定要删除吗？','<?=$this->url("user/user_partnerB_de")?>?id=<?=$val["id"]?>');" rel="tooltip" class="btn btn-small btn-danger" title="删除"><i class="icon-remove"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
            ...
            <div class="box box-color box-bordered">
                <div class="box-title">
                    ...
                    <?if(empty($porder2)&&$onumber<$snumber){?>
                        <a rel="tooltip" data-original-title="新增服务项目" href="<?=$this->url('user/user_porderB_add')?>?oid=<?=$registlist['id']?>&uid=<?=$registlist['uid']?>" class="btn btn-danger">
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($porder as $k=>$v){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="查看详情" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("user/user_porderB_details")?>?id=<?=$v["id"]?>"><i class="icon-eye-open"></i></a>
                                    <?if($v['state']!=2){?>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("user/user_porderB_up")?>?id=<?=$v["id"]?>"><i class="icon-edit"></i></a>
                                    <?}?>
                                </td>
                            </tr>
                        <?}?>
        ...
        <div class="span12">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    ...
                    <div class="actions">
                    <a rel="tooltip" data-original-title="新增经营范围" href="<?=$this->url("user/user_scope_add")?>?oid=<?=$oid?>" class="btn btn-danger" data-toggle="modal">
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($scope as $kp=>$vp){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("user/user_scope_up")?>?id=<?=$vp["id"]?>"><i class="icon-edit"></i></a>
                                    <a href="javascript:pub_alert_confirm(this,'确定要删除吗？','<?=$this->url("user/user_scope_de")?>?id=<?=$vp["id"]?>');" rel="tooltip" class="btn btn-small btn-danger" title="删除"><i class="icon-remove"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
...
<script type="text/javascript">
    ...
    $(function(){
        ...
        $("#partnersort").change(function(){
                var key = $('#partnersort').val();
                $.ajax({
                    url:'<?= $this->url("user/partner_type_ajax")?>',
                    type:'post',
                    data:{key:key},
                    dataType:'json',
                    success:function(e){
        ...
        $('#btnn1').on('click',function(){
            ...
            window.location.href="<?=$this->url('user/user_partnerB_add')?>?oid="+oid+"&uid="+uid+"&type="+type+"&sort="+sort;
        })
