        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <div class="box-content nopadding">
                    <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('ltd_bvi/payment_up_ajax')?>" name="form_regist" id="form_regist" enctype="multipart/form-data" >
