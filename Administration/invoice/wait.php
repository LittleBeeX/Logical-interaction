                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($voicelist as $k=>$v)if($va['state']==2&&$va['id']==$v['poid']){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="查看发票详情" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("invoice/wait_details")?>?id=<?=$v["id"]?>"><i class="icon-eye-open"></i></a>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("invoice/wait_up")?>?id=<?=$v["id"]?>"><i class="icon-edit"></i></a>
                                    <a href="javascript:pub_alert_confirm(this,'确定要删除吗？','<?=$this->url("invoice/wait_de")?>?id=<?=$v["id"]?>');"  class="btn btn-small btn-danger" rel="tooltip" title="删除发票"><i class="icon-remove"></i></a>
