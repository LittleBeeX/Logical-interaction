	...
	<div class="row-fluid">
		<div class="span12">
			<div class="box box-color box-bordered">
				...
				<form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('invoice/finish_up_ajax')?>"name="form_invoice" id="form_invoice" >
					...
					<div class="control-group">
                        ...
                        <div class="controls">
                            <select name="data[state]" class="input-xlarge">
                                <option value="1" <?if($userlist['state']==1){echo "selected";}?>>返回待审核状态</option>
                                <option value="2" <?if($userlist['state']==2){echo "selected";}?>>暂不处理</option>
                            </select>
                        </div>
                    </div>
