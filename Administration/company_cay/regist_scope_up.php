    ...
    <div class="breadcrumbs">
        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('company_cay/regist_scope_up_ajax')?>" name="form_bill" id="form_bill">
                    <div class="control-group">
                        <label class="control-label">经营范围描述</label>
                        <div class="controls">
                           <input type="text" name="data[describe]" value="<?=$scope['describe']?>"  class="input-xlarge" />
                        </div>
                    </div>
