        ...
        <div class="span12">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    ...
                    <div class="actions">
                        <a rel="tooltip" data-original-title="新增人员" href="<?=$this->url('company_cay/regist_partner_add')?>?oid=<?=$registlist['id']?>&uid=<?=$registlist['uid']?>" class="btn btn-danger">
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($peoplelist as $key=>$val){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="查看详情" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("company_cay/regist_partner_details")?>?id=<?=$val["id"]?>"><i class="icon-eye-open"></i></a>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("company_cay/regist_partner_up")?>?id=<?=$val["id"]?>"><i class="icon-edit"></i></a>
                                    <a href="javascript:pub_alert_confirm(this,'确定要删除吗？','<?=$this->url("company_cay/regist_partner_de")?>?id=<?=$val["id"]?>');" rel="tooltip" class="btn btn-small btn-danger" title="删除"><i class="icon-remove"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
            ...
            <div class="box box-color box-bordered">
                <div class="box-title">
                    ...
                    <?if(empty($porder2)&&$number<count($sin_f)){?>
                        <a rel="tooltip" data-original-title="新增服务项目" href="<?=$this->url('company_cay/regist_order_add')?>?oid=<?=$registlist['id']?>&uid=<?=$registlist['uid']?>" class="btn btn-danger">
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($porder as $k=>$v){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="查看详情" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("company_cay/regist_order_details")?>?id=<?=$v["id"]?>"><i class="icon-eye-open"></i></a>
                                    <?if($v['state']!=2){?>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("company_cay/regist_order_up")?>?id=<?=$v["id"]?>"><i class="icon-edit"></i></a>
                                    <?}?>
                                </td>
                            </tr>
                        <?}?>
        ...
        <div class="span12">
            <div class="box box-color box-bordered">
                <div class="box-title">
                    ...
                    <div class="actions">
                        <a rel="tooltip" data-original-title="新增经营范围" href="<?=$this->url('company_cay/regist_scope_add')?>?oid=<?=$registlist['id']?>&uid=<?=$registlist['uid']?>" class="btn btn-danger">
                ...
                <div class="box-content nopadding">
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        <thead>
                            <tr>
                                <th style="text-align: center;">序号</th>
                                <th style="text-align: center;">经营范围描述</th>
                        ...
                        <?foreach($scope as $k=>$v){?>
                            <tr>
                                <td><?=$k+1?></td>
                                <td><?=$v['describe']?></td> 
                                <td><?if($v['state']==1){echo "正常";}else if($v['state']==2){echo "删除";}?></td>  
                                <td><?=date('Y-m-d',$v['create_time'])?></td>
                                <td>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("company_cay/regist_scope_up")?>?id=<?=$v["id"]?>"><i class="icon-edit"></i></a>
                                    <a href="javascript:pub_alert_confirm(this,'确定要删除吗？','<?=$this->url("company_cay/regist_scope_del")?>?id=<?=$v["id"]?>');" rel="tooltip" class="btn btn-small btn-danger" title="删除"><i class="icon-remove"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
