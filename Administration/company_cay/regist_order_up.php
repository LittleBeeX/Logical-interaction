        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <div class="box-content nopadding">
                    <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('company_cay/regist_order_up_ajax')?>" name="form_regist" id="form_regist" enctype="multipart/form-data" >
                        <div class="control-group">
                            <label class="control-label">服务项目</label>
                            <div class="controls">
                                <ul class="service-list c66 fz22 plr30 pt40 mt10">
                                <?
                                $mm = explode(",",$order['project']);
                                foreach ($sin_f as $ks1 => $vs1) {?>
                                    <li>
                                        <label class="c28 ub ub-ac" >
                                            <input <?if(count($order22)==1){echo 'name="data[project][]"';}?><?if(count($order22)>1){echo 'disabled="disabled"';}?> type="checkbox" <?foreach ($mm as $ktr => $vtr) {
