            ...
            <div class="box box-color box-bordered">
                <div class="box-title">
                    ...
                    <a rel="tooltip" data-original-title="上传" href="#track" class="btn btn-danger" data-toggle="modal">
                        ...
                        <a rel="tooltip" data-original-title="下载" href="<?=$this->url('bill/manzi_down')?>" class="btn btn-danger">
                             <i class="icon-cloud-download"></i>下载报表(EXCEL格式)
                        </a>
                        <a rel="tooltip" data-original-title="添加" href="<?=$this->url('bill/manzi_in')?>" class="btn btn-danger">
                            <i class="icon-plus"></i> 新增MANZI报表
                        </a>
                    </div>
                </div>
                     ...
                     <tbody id= "zhajax">
                        <?foreach($sglist as $key=>$val){?>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="<?=$this->url("bill/manzi_details")?>?id=<?=$val["id"]?>" rel="tooltip" class="btn btn-small btn-primary" title="详情"><i class="icon-eye-open"></i></a>
                                    <a data-original-title="修改" rel="tooltip" class="btn btn-small btn-success" href="/index.php/<?=$this->languageName?>/sysadmin/bill/manzi_up?id=<?=$val['id']?>"><i class="icon-edit"></i></a>
                                    <a href="javascript:pub_alert_confirm(this,'确定要删除吗？','<?=$this->url("bill/manzi_de")?>?id=<?=$val["id"]?>');" class="btn btn-small btn-danger" rel="tooltip" title="删除"><i class="icon-remove"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </tbody>
...
<div id="track" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
        ...
        <form action="<?=$this->url('bill/manziUpExcel')?>" method="POST" class="form-horizontal form-bordered form-validate" name="track_in" id="track_in">
                    ...
                    <div class="fileupload fileupload-new" data-provides="fileupload">
                        <div class="input-append">
                            ...
                            <span id="ss" class="btn btn-file">
                                ...
                                <input type="file" name="file_manzi">
                            </span>
