	...
	<div class="row-fluid">
		<div class="span12">
			<div class="box box-color box-bordered">
				<div class="box-title">
					<h3><i class="icon-user"></i>添加账单</h3>
				</div>
				<div class="box-content nopadding">
					<form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('bill/manzi_in_ajax')?>" name="form_bill" id="form_bill">
						...
						<div class="control-group">
							...
							<textarea type="text" name="data[abstract]" style="resize: none;width: 400px; height: 100px;"></textarea>
								...
								<!-- <input name="data[abstract]" type="text"  value="" placeholder="请输入摘要" class="input-xlarge" > -->
						</div>
						<div class="control-group">
							...
							<textarea type="text" name="data[remark]" style="resize: none;width: 400px; height: 100px;" ></textarea>
								...
								<!-- <input name="data[remark]" type="text"  value="" placeholder="请输入备注" class="input-xlarge" > -->
						</div>
