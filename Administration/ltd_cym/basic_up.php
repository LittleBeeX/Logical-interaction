    ...
    <div class="breadcrumbs">
        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('ltd_cym/basic_up_ajax')?>" name="form_bill" id="form_bill">
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($people_list as $key=>$val){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="修改信息" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("ltd_cym/member_up")?>?id=<?=$val["id"]?>"><i class="icon-edit"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($order_list as $k=>$v){?>
                            <tr>
                                ...
                                <td>
                                    <a data-original-title="修改信息" rel="tooltip" class="btn btn-small btn-success" href="<?=$this->url("ltd_cym/payment_up")?>?id=<?=$v["id"]?>"><i class="icon-edit"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
                    ...
                    <table class="table table-hover table-nomargin dataTable table-bordered" width="100%">
                        ...
                        <?foreach($order_list_de as $k=>$v){?>
                            <tr>
                                ...
                                <td><?=date('Y-m-d',$v['change_time'])?></td>
                                <td>
                                    <a data-original-title="查看信息" rel="tooltip" class="btn btn-small btn-primary" href="<?=$this->url("ltd_cym/payment_se")?>?id=<?=$v["id"]?>"><i class="icon-eye-open"></i></a>
                                </td>
                            </tr>
                        <?}?>
                    </table>
