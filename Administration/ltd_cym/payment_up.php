        ...
        <div class="span12">
            ...
            <div class="box box-color box-bordered">
                ...
                <div class="box-content nopadding">
                    <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('ltd_cym/payment_up_ajax')?>" name="form_regist" id="form_regist" enctype="multipart/form-data" >
                                ...
                                <?foreach ($service as $key => $value) {?>
                                    <li>
                                        <label class="c28 ub ub-ac" >
                                            <input  name="data[project][]" type="checkbox" value="<?=$value['id']?>" class="form-checkbox mr10 inputa" <?if(in_array($value['id'], $project)){?>checked="checked"<?}?> />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                               <select id="sele1" name="data[currency]">
                                    <option value="1" <?if($info['currency']==1){?>selected<?}?>>人民币</option>
                                    <option value="2" <?if($info['currency']==2){?>selected<?}?>>LITTLE</option>
                               </select>
                            </div>
                        </div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                               <select id="sele2" name="data[way]">
                                    <option value="0" <?if($info['way']==0){?>selected<?}?>>银行卡转账</option>
                                    <option value="2" <?if($info['way']==2){?>selected<?}?>>数字钱包</option>
                               </select>
                            </div>
                        </div>
                            ...
                            <div class="controls">
                               <select name="data[state]" class="input-xlarge"><!--  -->
                                    <?foreach ($orderlist_state as $kc => $vc) {?>
                                     <option value="<?echo $kc+1;?>"<?if($info['state']==($kc+1)){echo "selected";}?>>
                                     <?=$vc?>
                                     </option>
                                <?}?>
                                </select>
...
<!-- $("#btn").on('click',function(){
            var aa = "<?foreach ($service as $ks1 => $vs1){echo $vs1['yn_choice'];}?>";
