        ...
        <div class="span12">
            ...
            <div class="box">
                <div class="box-content">
                    <ul class="tiles tiles-center nomargin">
                        ...
                        <?}?>
                            <a href="<?=$this->url("ltd_cym/regist")?>"><span><i class="icon-book"></i></span><span class="name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">注册申请</font></font></span></a>
                        </li>
                        ...
                        <?}?>
                            <a href="<?=$this->url("ltd_cym/wait")?>"><span><i class="icon-print"></i></span><span class="name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">订单审核</font></font></span></a>
                        </li>
                        &nbsp;&nbsp;<i class="icon-arrow-right"></i>
                        <li class="blue">
                        <?if($r3!=0){?>
                        ...
                        <?}?>
                            <a href="<?=$this->url("ltd_cym/sign")?>"><span><i class="icon-bookmark"></i></span><span class="name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">文件签署</font></font></span></a>
                        </li>
                        &nbsp;&nbsp;<i class="icon-arrow-right"></i>
                        <li class="brown">
                        <?if($r4!=0){?>
                        ...
                        <?}?>
                            <a href="<?=$this->url("ltd_cym/report")?>"><span><i class="icon-exchange"></i></span><span class="name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">注册申报</font></font></span></a>
                        </li>
                        &nbsp;&nbsp;<i class="icon-arrow-right"></i>
                        <li class="satgreen">
                        <?if($r5!=0){?>
                        ...
                        <?}?>
                            <a href="<?=$this->url("ltd_cym/check")?>"><span><i class="icon-globe"></i></span><span class="name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">注册审查</font></font></span></a>
                        </li>
                        &nbsp;&nbsp;<i class="icon-arrow-right"></i>
                        <li class="orange">
                        <?if($r6!=0){?>
                        ...
                        <?}?>
                            <a href="<?=$this->url("ltd_cym/finish")?>"><span><i class="icon-leaf"></i></span><span class="name"><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">注册完成</font></font></span></a>
                        </li>
                    </ul>
                </div>
            </div>
            <div class="box box-color box-bordered">
                ...
                <div class="box-content nopadding">
                    <form class="form-horizontal form-bordered form-validate" method="POST" action="<?=$this->url('ltd_cym/member_up_ajax')?>" name="form_regist" id="form_regist" enctype="multipart/form-data" >
                    <div class="control-group">
                            <label class="control-label">类型</label>
                            <div class="controls">
                                <select  name="data[type]" class="input-xlarge">
                                <?foreach ($registerpeple_type as $ka => $va) {?>
                                     <option value="<?echo $ka+1;?>"<?if($info['type']==($ka+1)){echo "selected";}?>>
                                     <?=$va?>
                                     </option>
                                <?}?>
                                </select>
                            ...
                            <div class="controls">
                               <select  name="data[nationality]" class="input-xlarge">
                                <?foreach ($country_code as $kb => $vb) {?>
                                    <option value="<?echo $kb+1;?>"<?if($info['nationality']==($vb['country'])){echo "selected";}?> >
                                    <?echo $vb['country'];?></option>
                                <?}?>
                                </select>
                                <!-- <input  type="text" name="data[nationality]"  value="<?=$info['nationality']?>" class="input-xlarge" > -->
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">名字</label>
                            <div class="controls">
                                <input  type="text" name="data[name]"  value="<?=$info['name']?>" class="input-xlarge" >
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="data[sex]" class="input-xlarge"><!--  -->
                                    <option value="1" <?if($info['sex']==1){echo "selected";}?>>男</option>
                                    <option value="2" <?if($info['sex']==2){echo "selected";}?>>女</option>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input  type="text" name="data[email]"  value="<?=$info['email']?>" class="input-xlarge" >
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">联系电话</label>
                            <div class="controls">
                                <input  type="text" name="data[mobile]"  value="<?=$info['mobile']?>" class="input-xlarge" >
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">微信号</label>
                            <div class="controls">
                                <input  type="text" name="data[wechat]"  value="<?=$info['wechat']?>" class="input-xlarge" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">出生日期</label>
                            <div class="controls">
                                <input type="text" id="created" name="data[date_birth]" value="<?=date('Y-m-d',$info['date_birth'])?>" placeholder="出生日期" class="input-medium datepick valid" />
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input  type="text" name="data[place_birth]"  value="<?=$info['place_birth']?>" class="input-xlarge" >
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?=$info['card_a']?>"></div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?=$info['card_b']?>"></div>
                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                    <div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                               <select name="data[audit_img_state]" class="input-xlarge"><!--  -->
                                 ...
                                 <option value="<?echo $kc+1;?>"<?if($info['audit_img_state']==($kc+1)){echo "selected";}?>><?=$vc?></option>
                                     <?}?>
                                </select>
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input  type="text" name="data[audit_img_note]"  value="<?=$info['audit_img_note']?>" class="input-xlarge" />
                            </div>
                        </div>
                            ...
                            <div class="controls">
                               <select  name="data[country_code]" class="input-xlarge">
                                <?foreach ($country_code as $kd => $vd) {?>
                                    <option value="<?echo $kd+1;?>"<?if($info['country_code']==($vd['ccode'])){echo "selected";}?> >
                                    <?echo $vd['country'];?><?echo $vd['ccode'];?></option>
                                <?}?>
                                </select>
                                <!-- <input  type="text" name="data[country_code]"  value="<?=$info['country_code']?>" class="input-xlarge" /> -->
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                               <!--  <select name="data[passport_type]" class="input-xlarge">
                                 ...
                                 <option value="<?echo $ke+1;?>"<?if($info['passport_type']==($ke+1)){echo "selected";}?>><?=$ve?></option>
                                     <?}?>
                                </select> -->
                                <input  type="text" name="data[passport_type]"  value="<?=$info['passport_type']?>" class="input-xlarge" />
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">护照号</label>
                            <div class="controls">
                                <input  type="text" name="data[passport_no]"  value="<?=$info['passport_no']?>" class="input-xlarge" >
                            </div>
                        </div>
                        <div class="control-group">
                            <label class="control-label">护照签发地点</label>
                            <div class="controls">
                                <input  type="text" name="data[place_issue]"  value="<?=$info['place_issue']?>" class="input-xlarge" >
                            </div>
                        </div>
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <div class="fileupload fileupload-new" data-provides="fileupload"><input type="hidden">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;"><img src="<?=$info['passport']?>"></div>
                                    <div class="fileupload-preview fileupload-exists thumbnail" style="max-width: 200px; max-height: 150px; line-height: 20px;"></div>
                                    <div>
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <input type="text" id="created" name="data[date_issue]" value="<?=date('Y-m-d',$info['date_issue'])?>" placeholder="签发时间" class="input-medium datepick valid" />
                                <span class="help-block error valid" for="publishtime"></span>
                            </div>
                        </div>
                        <div class="control-group">
                        ...
                        <div class="control-group">
                            ...
                            <div class="controls">
                                <select name="data[audit_state]" class="input-xlarge"><!--  -->
                                 ...
                                 <option value="<?echo $kaa+1;?>"<?if($info['audit_state']==($kaa+1)){echo "selected";}?>><?=$vbb?></option>
                                     <?}?>
                                </select>
                            </div>
                        </div>
